...
$PAGE->set_url($CFG->wwwroot . '/local/category_img/category_img.php');
...
if ($mform->is_cancelled()) {
    ...
    redirect(new moodle_url('/local/category_img/category_img.php'));
...
'local_category_img', 'userfile',$fromform->userfile, array('subdirs' => true));
    ...
    if(!empty($data)){
      ...
      redirect(new moodle_url('/local/category_img/category_img.php'),get_string('update','local_category_img'));
    }
  }else{
      file_save_draft_area_files($fromform->userfile, $context->id,
'local_category_img', 'userfile',$fromform->userfile, array('subdirs' => true));
      ...
      redirect(new moodle_url('/local/category_img/category_img.php'),get_string('insert','local_category_img'));
...
foreach ($categorynames as $categoryname) {
  ...
  $html.=html_writer::start_tag('td');
  //getting image link.
  $link=$CFG->wwwroot."/local/category_img/category_img.php?id=".$categoryname->id."";
